...
if ENV:
    ...
    GIT_REPO_URL = environ.get('GIT_REPO_URL', "https://github.com/bhumiharsaurabh/GitGram")
else:
...
print("If you need more help from Me, Join @full_masti_clubs in Telegram.")
...
def support(_bot, update):
    ...
    message = update.effective_message
    message.reply_text(
        f"*ɢᴇᴛᴛɪɴɢ sᴜᴘᴘᴏʀᴛ*\n\nꜰᴏʀ ɢᴇᴛᴛɪɴɢ ʜᴇʟᴘ ɪɴ ᴜsɪɴɢ ᴍᴇ, ᴊᴏɪɴ [katil Support](https://t.me/full_masti_clubs).",
...
def source(_bot, update):
    ...
    message = update.effective_message
    message.reply_text(
        f"*sᴏᴜʀᴄᴇ​*:\n[ɢɪᴛɢʀᴀᴍ ʀᴇᴘᴏ​](https://github.com/bhumiharsaurabh/GitGram).",
        disable_web_page_preview=True,
        parse_mode="markdown"
    )
